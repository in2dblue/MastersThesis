...
def read_input_files(file_paths, max_sentence_length=-1):
    ...
    for file_path in file_paths.strip().split(","):
        with open(file_path, "r") as f:
            sentence = []
            with open('./modeldata/lcp_single_train_corrected_new_token_predictions_with_features.tsv', 'wt') as out_file:
                ...
                for line in f:
                    ...
                    if len(line) > 0:
                        ...
                        word, prob, label, pred = line_parts
                        ...
                        tsv_writer.writerow([word, word_length, word_syn, word_hyper, word_hypo, word_syl, ogden_bin, subimdb_bin, simplewiki_bin, lang8_freq, prob, label, pred])
